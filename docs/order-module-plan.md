...
8. **License metadata fixed** — `order-openapi.yaml` now uses the repository's Personal Evaluation License notice.
...
- Keep license metadata in `order-openapi.yaml` aligned with the repository's Personal Evaluation License notice

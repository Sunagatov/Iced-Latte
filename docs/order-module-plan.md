...
8. **License mismatch** — `order-openapi.yaml` says MIT; project now uses Apache License 2.0.
...
- Fix license in `order-openapi.yaml` from MIT to the repository's Apache License 2.0 notice

...
APP_JWT_ACCESS_KEY_ID=access-current
APP_JWT_REFRESH_KEY_ID=refresh-current
APP_JWT_PREVIOUS_SECRET=...
APP_JWT_PREVIOUS_REFRESH_SECRET=...
APP_JWT_PREVIOUS_ACCESS_KEY_ID=access-previous
APP_JWT_PREVIOUS_REFRESH_KEY_ID=refresh-previous
```

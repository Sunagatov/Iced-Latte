...
public class ReviewExceptionHandler {
    ...
    @ExceptionHandler(UnsupportedReviewFormatException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiErrorResponse handleUnsupportedReviewFormatException(final UnsupportedReviewFormatException exception) {

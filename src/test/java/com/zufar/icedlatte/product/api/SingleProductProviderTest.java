...
class SingleProductProviderTest {
    ...
    void shouldReturnProductWhenProductIdExists() {
        ...
        when(productPictureLinkUpdater.updateByProductId(any(ProductInfoDto.class))).thenReturn(mock(ProductInfoDto.class));
    ...
    void shouldThrowExceptionWhenProductIdNotExists() {
        ...
        when(productPictureLinkUpdater.updateByProductId(any(ProductInfoDto.class))).thenReturn(any(ProductInfoDto.class));

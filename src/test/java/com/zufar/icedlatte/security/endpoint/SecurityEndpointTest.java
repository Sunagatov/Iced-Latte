...
class SecurityEndpointTest extends IntegrationTestBase {
    ...
    private static final String SECURITY_AUTHENTICATE_USER_NOT_FOUND =
            "/security/model/security-authenticate-not-found-user.json";
    private static final String SECURITY_REGISTRATION_WITHOUT_NAME =
            "/security/model/security-registration-without-name.json";
    private static final String SECURITY_REGISTRATION_LENGTH_NAME_LESS_TWO_WORD =
            "/security/model/security-registration-length-name-less-two-word.json";
    private static final String SECURITY_REGISTRATION_LENGTH_NAME_MORE_128_WORD =
            "/security/model/security-registration-length-name-more-128-word.json";
    private static final String SECURITY_REGISTRATION_WITHOUT_LAST_NAME =
            "/security/model/security-registration-without-last-name.json";
    private static final String SECURITY_REGISTRATION_LENGTH_LAST_NAME_LESS_TWO_WORD =
            "/security/model/security-registration-length-last-name-less-two-word.json";
    private static final String SECURITY_REGISTRATION_LENGTH_LAST_NAME_MORE_128_WORD =
            "/security/model/security-registration-length-last-name-more-128-word.json";
    private static final String SECURITY_REGISTRATION_EMPTY_EMAIL =
            "/security/model/security-registration-empty-email.json";
    private static final String SECURITY_REGISTRATION_LENGTH_EMAIL_LESS_EIGHT_WORD =
            "/security/model/security-registration-length-email-less-eight-word.json";
    private static final String SECURITY_REGISTRATION_LENGTH_EMAIL_MORE_128_WORD =
            "/security/model/security-registration-length-email-more-128-word.json";
    private static final String SECURITY_REGISTRATION_EMPTY_PASSWORD =
            "/security/model/security-registration-empty-password.json";
    private static final String SECURITY_REGISTRATION_LENGTH_PASSWORD_LESS_EIGHT_CHARACTERS =
            "/security/model/security-registration-length-password-less-eight-characters.json";
    private static final String SECURITY_REGISTRATION_LENGTH_PASSWORD_MORE_128_CHARACTERS =
            "/security/model/security-registration-length-password-more-128-characters.json";
    private static final String SECURITY_REGISTRATION_PASSWORD_WITHOUT_WORD =
            "/security/model/security-registration-password-without-word.json";
    ...
    void shouldRegistrationNewUser() {
        given(specification)
                .body(getRequestBody(SECURITY_REGISTRATION))
                .post("/register")
                .then()
    ...
    void shouldFailRegistrationWithoutName() {
        given(specification)
                .body(getRequestBody(SECURITY_REGISTRATION_WITHOUT_NAME))
                .post("/register")
                .then()
    ...
    void shouldFailRegistrationWithShortName() {
        given(specification)
                .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_NAME_LESS_TWO_WORD))
                .post("/register")
                .then()
                .statusCode(HttpStatus.BAD_REQUEST.value())
                .body("detail", notNullValue());
    ...
    void shouldRegistrationNewUserFailedLengthNameMoreOneHundredTwentyEightWord() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_NAME_MORE_128_WORD))
                        .post("/register"),
    ...
    void shouldRegistrationNewUserFailedLengthLastNameLessTwoWord() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_LAST_NAME_LESS_TWO_WORD))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedLengthLastNameMoreOneHundredTwentyEightWord() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_LAST_NAME_MORE_128_WORD))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedWithoutLastName() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_WITHOUT_LAST_NAME))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedEmailEmpty() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_EMPTY_EMAIL))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedPasswordEmpty() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_EMPTY_PASSWORD))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedLengthEmailLessEightWord() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_EMAIL_LESS_EIGHT_WORD))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedLengthEmailMoreOneHundredEightWord() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_EMAIL_MORE_128_WORD))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedLengthPasswordLessEightCharacters() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_PASSWORD_LESS_EIGHT_CHARACTERS))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedLengthPasswordMoreOneHundredEightCharacters() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_LENGTH_PASSWORD_MORE_128_CHARACTERS))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldRegistrationNewUserFailedPasswordWithoutWord() {
        assertRestApiBadRequestResponse(
                given(specification)
                        .body(getRequestBody(SECURITY_REGISTRATION_PASSWORD_WITHOUT_WORD))
                        .post("/register"),
                SECURITY_SCHEMA_FAILED);
    }
    ...
    void shouldAuthenticateUser() {
        ...
        assertRestApiOkResponse(
                given(specification).body(getRequestBody(SECURITY_AUTHENTICATE)).post("/authenticate"),
                SECURITY_SCHEMA);
    }
    ...
    void shouldFailAuthenticationForNonExistentUser() {
        given(specification)
                .body(getRequestBody(SECURITY_AUTHENTICATE_USER_NOT_FOUND))
                .post("/authenticate")
                .then()
    ...
    void shouldFailAuthenticationWithIncorrectPassword() {
        given(specification)
                .body("{\"email\":\"olivia@example.com\",\"password\":\"wrongpassword1\"}")
                .post("/authenticate")
                .then()
                .statusCode(HttpStatus.UNAUTHORIZED.value())
                .body("detail", notNullValue());

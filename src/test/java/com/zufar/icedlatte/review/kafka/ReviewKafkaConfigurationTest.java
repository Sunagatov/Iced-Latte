...
class ReviewKafkaConfigurationTest {
    ...
    void kafkaComponentsAreActiveOnlyWhenKafkaIsEnabled() throws Exception {
        ...
        assertKafkaEnabledCondition(Class.forName(
                "com.zufar.icedlatte.review.messaging.kafka.inbox.ReviewCreatedKafkaConsumerConfiguration"));
        assertKafkaEnabledCondition(
                Class.forName("com.zufar.icedlatte.review.messaging.kafka.outbox.ReviewCreatedOutboxEventListener"));
        assertKafkaEnabledCondition(
                Class.forName("com.zufar.icedlatte.review.messaging.kafka.inbox.ReviewCreatedInboxProcessor"));
    }

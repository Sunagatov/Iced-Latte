...
@AnalyzeClasses(packages = "com.zufar.icedlatte", importOptions = ImportOption.DoNotIncludeTests.class)
...
class ArchitectureRulesTest {
     ...
     */
    @ArchTest
    static final ArchRule feature_packages_should_be_free_of_cycles = slices().matching("com.zufar.icedlatte.(*)..")
            .should()
            .beFreeOfCycles()
